  ...
  return (
    <>
      ...
      <div className="p-3">
        ...
        <Link
          to="/search"
          className="py-1 px-2 m-3 text-slate-50 bg-blue-600 dark:bg-blue-500 active:bg-blue-600 disabled:text-slate-500 disabled:bg-blue-300"
        >
          {translations["Discover tokens"]}
        </Link>
      </div>
    </>
  );
